...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        EmptyRecyclerView mRecyclerView = rootView.findViewById(R.id.history_recycler_view);
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                myAdapter.clear();
//                Log.d("fuckhim", "onRefresh: "+MyApplication.newsOperator.DB.getSize());
//                Log.d("fuckhim", "onRefresh: "+MyApplication.newsOperator.RefreshRead().size());
                myAdapter.addList(MyApplication.newsOperator.RefreshRead());
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                ...
                myAdapter.addList(MyApplication.newsOperator.LoadMoreRead());
                myAdapter.notifyDataSetChanged();
            }
        });
